...
router.get('/summary', function (req, res) {
  ...
  res.render('summary', {
    ...
    main: {
      summary: {
        text: 'Open-minded for new technologies, with 1 years of experience in development.When ever I start to work on a new project I learn the domain and try to understand the idea of the project.      Good team player, every colleague is a friend to me.',
        title: 'Summary',
      },
          ...
          projects: [
            {
              ...
              about:
                'Project Online is a flexible online project management software to help you manage projects and everyday work.',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'Background verification is a process many organizations carry out in order to verify the information provided by the candidate during hiring.',
                },
                {
                  name: 'A knowledge of basic SEO can have a noticeable impact.',
                },
              ],
              stackAmount: 5,
              awardAmount: 10,
...
>>>>>>> 7791842a28ade9b8b28583c22df1093810e4b10e
    layout: 'shop',
    navigation: {
      links: [
        {
